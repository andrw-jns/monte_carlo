...
## 1. Point forecasts: the bootstrap method
...
## 2. Interval forecasts: Monte Carlo simulation

The Monte Carlo method (or a similar method) is applicable if workshop participants are asked to forecast an interval.
